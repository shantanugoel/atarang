...
///
/// All four are real as of Phase 9. Shipping the selector at full width from
/// Phase 4, with the stages filling in one milestone at a time, is what kept the
/// layout from being rebuilt around each new one.
